...
if(isset($_GET['id'])) {
	$profile_uid=$_SESSION['pet_unique_id'];
}
?>
<html>
...
//$child_id = $_SESSION["child_user_id"];
        ...
        <div class="main-content user-pro-dtls-page usr-feed-page-nw">
            <div class="main-content-inn col-three main-content-full">
				...
				<?php
				$profileqry=mysqli_query($conn,"SELECT * FROM user_info WHERE pet_unique_id='$profile_uid'");
                    ...
                    <div class="col-first">
                        <div class="user-pro-dtls">
                            ...
                            <div class="usr-pro-dtl-r">
								...
								<?php
$frnchkqry=mysqli_query($conn,"SELECT user_info.pet_unique_id,addfriend.status FROM addfriend JOIN user_info ON addfriend.child_id = user_info.pet_unique_id WHERE addfriend.parent_id = '$parent_id'
UNION ALL 
SELECT user_info.pet_unique_id,addfriend.status FROM addfriend JOIN user_info ON addfriend.parent_id = user_info.pet_unique_id WHERE addfriend.child_id = '$parent_id'");
...
F.status='1'";
                        ...
                        <div class="fr-list">
                            ...
                            $display2 = "SELECT pet_name,email,parent_id,STATUS,child_id FROM user_info JOIN addfriend ON addfriend.`parent_id` = user_info.`pet_unique_id` WHERE (parent_id='$profile_uid' OR child_id='$profile_uid') AND(parent_id!='$profile_uid') AND STATUS=1";
					   ...
					   <a href="profile-page1.php?id=<?= $row['pet_unique_id'] ?>"><?php echo $row["pet_name"] ?></a>
                        ...
                        <div class="fr-list fr-sug">
                            ...
                            <div class="fr-li-cont">
                                ...
                                //$friend_ =
//$display3="SELECT DISTINCT user_info.pet_unique_id,user_info.pet_name FROM addfriend JOIN user_info ON addfriend.child_id=user_info.pet_unique_id WHERE addfriend.parent_id NOT IN (SELECT parent_id FROM addfriend WHERE addfriend.parent_id='$parent_id')";
                                $display3 = "SELECT DISTINCT user_infoo.pet_unique_id,user_infoo.pet_name FROM user_infoo JOIN `addfriend` ON addfriend.`child_id`=user_infoo.pet_unique_id 
