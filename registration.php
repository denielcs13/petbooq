...
$(document).ready(function(){
    ...
    <body>
        ...
        <?php
        session_start();
        $error_name = $error_typepet = $error_date = $error_month = $error_year = $error_owner_name = $error_owner_email = $error_passwords = $error_code = $error_mobile = "";
        if (isset($_POST['user_submit'])) {
            ...
            if (empty($code)) {
                $error_country = "Select country code";
            }
            ...
            if (!empty($pet_name) && !empty($typepet) && !empty($date_of_birth) && !empty($owner_name) && !empty($owner_email) && !empty($passwords) && !empty($country) && !empty($code) && !empty($mobile)) {
...
?></div>
                                <div class="reg-f-row">
                                    <select class="country" name="type_pet" id="type_pet">
...
?> </div>
                                ...
                                <select name="code" id="country"  class="sml">
