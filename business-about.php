...
<div class="main-content user-pro-dtls-page usr-feed-page-nw about-page groups-page" id="about-load-ref">
...
<div class="col-first-side">
                    <div class="pro-right-sec">
                        ...
                        ?>
                        <div class="grp-name"><h2><i class="fa fa-paw"></i><br><?php echo $display['company_name'] ?></h2></div>
                        <div class="grp-top">
                            <h4>Page Setting</h4>
                            <ul>
...
<div class="pro-timeline"><?php if($display['profile_image']=="") {
							echo "<img src='images/paw.gif'>";
							}
							else {
							?>
							<img src="<?= $display['profile_image'] ?>" alt="user image" />
							<?php } ?>
							
							
							</div>
							
<div class="usr-pro-img"><?php if($profileinfo['bg_image']=="") {
...
<div class="usr-cnct-l"><!--<a href="#">Connect</a>--> <a href="business-edit.php" class="edit">Edit</a></div>
</div>
</div>
...
</a></span><p class="user-nm"><a href="about3.php?id=<?= $display['business_uniqueid'] ?>"><?= $display['company_name'] ?></a></p></h2>
<h3><?= $propost['title'] ?></h3>
