                           ...
                           <form method="post" id="post-form">
                                ...
                                <div class="upload-btn uplbtn-top uplbtn-btm-t">
                                    ...
                                    <div class="upload-btn-hld upload-btn-hld-top">
                                        ...
                                        <!--<input class="fl-upld" value="upload" type="submit"><a href="#" class="ad-m">+</a>--> <input value="Post" id="post-submit-btn" name="submit" class="fl-subm" type="submit">
                                    </div>
                                </div>
								</form>
      ...
      $.ajax(
            {
                ...
                beforeSend: function()
                {
					...
					//if(data==false) {
						//$('.ajax-load').hide();
						$().append("NO MORE POSTS TO DISPLAY");
					//}
                }
            ...
            ?>
                        ...
                        <div class="fr-list fr-req">
                            ...
                            <div class="fr-li-cont">
                                <div class="fr-li-row">
                                    <div class="fr-t-l">
                                        <a href="#"><span class="user-icn-img"><img src="images/fr-img-icon.png" alt="user image"><span class="fr-nm"><?= $frnd_info['pet_name'] ?></span></span></a>
                                    </div>
