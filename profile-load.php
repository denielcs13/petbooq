...
$result=mysqli_query($conn,"SELECT * FROM addfriend JOIN user_info ON user_info.pet_unique_id = addfriend.parent_id WHERE (addfriend.parent_id='$parent_id' OR addfriend.child_id='$parent_id') AND (addfriend.parent_id='$friend_id' OR addfriend.child_id='$friend_id')");
if (!$result) {
    printf("Error: %s\n", mysqli_error($conn));
    exit();
}
                            ...
                            if (mysqli_num_rows($show_result)) {
                                ...
                                <?php while ($row = mysqli_fetch_assoc($show_result)) {
                                    ...
                                    <div class="fr-li-cont">
                                        <div class="fr-li-row">
                                            <div class="fr-t-l">
                                                <a href="#"><span class="user-icn-img"><img src="images/user_image01.jpg" alt="user image" /><span class="fr-nm"><a href=""><?php echo $row["pet_name"] ?></a></span></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
